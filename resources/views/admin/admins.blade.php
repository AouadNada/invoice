...
@endif
        ...
        <div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-body">
							<h4 class="card-title mg-b-0">Admin info</h4><br>
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap" style="width:98%;">
										...
										<tbody>
                                            @foreach ($adminsWithInvoiceCounts as $user)
                                                <tr>
                                                    <td>{{ $user->name }}</td>
                                                    <td>{{ $user->email }}</td>
                                                    <td>{{ $user->country }}</td>
													...
													<td>
														<div class="btn-icon-list">
															<button class="btn btn-danger btn-icon modal-effect" data-effect="effect-scale" data-toggle="modal" data-admin_id="{{ $user->id }}" data-admin_name="{{ $user->name }}" data-target="#modaldemo8"><i class="typcn typcn-trash"></i></button>
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content modal-content-demo">
														...
														<div class="modal-body">
															<p>Confirm the deletion of this admin. Access to our website and their account will be revoked.</p>
